...
public class PagoController implements IController {
    ...
    private void buscarInscripcion() {
        try {
            ...
            vista.setNombreCliente("Cliente Ejemplo");
            actualizarResumenVista();
        } catch (Exception ex) {
    ...
    private void actualizarResumenVista() {
        ...
        vista.actualizarResumen(
            (String) datos.get("idInscripcion"),
            (String) datos.get("nombreCliente"),
            (String) datos.get("monto"),
            (String) datos.get("metodoPago"),
            (String) datos.get("estadoInscripcion")
        );
    }
