...
public class GestionInventario extends JPanel {
    ...
    public GestionInventario() {
        ...
        btnGestionarTipos.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(SEPARADOR), new EmptyBorder(8, 16, 8, 16)));
    ...
    public JButton getBtnExaminarFoto() { return btnExaminarFoto; }
    public JButton getBtnGestionarTipos() { return btnGestionarTipos; }
    public JComboBox<String> getComboTipos() { return cbTipoEquipo; }
    public JComboBox<String> getComboEstado() { return cbEstado; }
    public JTable getTabla() { return tablaEquipos; }
    public DefaultTableModel getModeloTabla() { return modeloTabla; }

    public String obtenerIdEquipo() { return txtIdEquipo.getText().trim(); }
    public String obtenerNombre() { return txtNombre.getText().trim(); }
    public String obtenerEstado() { return (String) cbEstado.getSelectedItem(); }
    public String obtenerFotoRuta() { return txtFotoRuta.getText().trim(); }
    public Date obtenerFecha() { return dateChooserAdquisicion.getDate(); }
    public String obtenerTipoSeleccionado() { return (String) cbTipoEquipo.getSelectedItem(); }

    public void establecerIdEquipo(String id) { txtIdEquipo.setText(id); }
    public void establecerNombre(String nombre) { txtNombre.setText(nombre); }
    public void establecerFotoRuta(String ruta) { txtFotoRuta.setText(ruta); }
    public void establecerFecha(Date fecha) { dateChooserAdquisicion.setDate(fecha); }
    ...
    public void limpiarFormulario() {
        ...
        if (cbTipoEquipo.getItemCount() > 0) cbTipoEquipo.setSelectedIndex(0);
